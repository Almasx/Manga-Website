...
const Bookmark = ({
  ...
  return (
    <>
      <div className="relative -mx-4 mb-12 -mt-3 flex h-52 flex-col justify-center bg-gradient bg-cover px-5 drop-shadow-[0_0px_74px_rgba(74,84,235,0.5)] ">
        <h2 className="text-5xl font-bold text-light">{title}</h2>
        <TextField
          name="search"
          className="!absolute right-[26px] bottom-0 left-2.5 translate-y-1/2"
      ...
      <div className="grid grid-cols-6 gap-5 ">
        {isLoading
          ? Array(12).fill(<ComicsCardLoading />)
